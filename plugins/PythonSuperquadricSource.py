...
@smproxy.source(name="PythonSuperquadricSource2", label="PythonSuperquadricSource2")
class PythonSuperquadricSource2(VTKPythonAlgorithmBase):
    """This is dummy VTKPythonAlgorithmBase subclass that
    simply puts out a Superquadric poly data using a vtkSuperquadricSource
    internally"""
    def __init__(self, Center=10):
