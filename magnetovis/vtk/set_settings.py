def set_settings(vtkObj, settings):
    ...
    for setting in settings:
        ...
        logging.info(vtkName + " default {} = {}".format(key, default))
        ...
        logging.info(vtkName + " setting {} = {}".format(key, val))
        ...
        try:
            ...
            try:
                ...
                logging.warning("Cannot evaluate vtk." + vtkName + "().Set" + key + "()")
                logging.warning("Cannot evaluate vtk." + vtkName + "().Set" + key + "(" + str(val) + ")")
