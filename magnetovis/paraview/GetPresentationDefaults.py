def PrintPresentationDefaults(sourceName, all=False):

  import pprint
  import json
  defaults = GetPresentationDefaults(sourceName, all=all)
  pp = pprint.PrettyPrinter(indent=2, sort_dicts=False, width=200) 
  pp.pprint(defaults)
  #print(defaults)
  #print(json.dumps(defaults, indent=1))

def GetPresentationDefaults(sourceName, all=False):
  ...
  if is_magnetovis and 'GetPresentationDefaults' in object.__dict__:
    # If function GetPresentationDefaults() in
    # magnetovis/Sources/{sourceName}.py file
    defaults = object.GetPresentationDefaults()
  else:
    defaults = {}
...
if __name__ == "__main__":
  #PrintPresentationDefaults("Text")
  #GetPresentationDefaults("Axis", all=True)
  #print(GetPresentationDefaults("Axis", all=True))
  PrintPresentationDefaults("Axis", all=True)
  #PrintPresentationDefaults("Curve", all=True)
